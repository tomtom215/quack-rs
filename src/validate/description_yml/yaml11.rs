...
mod tests {
    ...
    /// Values at every resolver edge and the type `PyYAML` gives each.
    const RESOLVER_EDGES: &[(&str, Option<&str>)] = &[
        ("1:2", Some("an integer")),
        ("1:20", Some("an integer")),
        ("1:59", Some("an integer")),
        ("1:60", None),
        ("1:5a", None),
        ("1:2:3", Some("an integer")),
        ("1:234", None),
        ("0:30", None),
        ("01:30", None),
        ("1_0:30", Some("an integer")),
        ("-1:30", Some("an integer")),
        ("+1:30", Some("an integer")),
        ("1::30", None),
        (":30", None),
        ("1:30.5", Some("a float")),
        ...
        ("1:60.5", None),
        ("1:30.5e+1", None),
        ("1:30._5", Some("a float")),
        ("-1:30.25", Some("a float")),
        ("0", Some("an integer")),
        ("00", Some("an integer")),
        ("007", Some("an integer")),
        ("08", None),
        ...
        ("0b", None),
        ("0b2", None),
        ("0b1_0", Some("an integer")),
        ("0x", None),
        ("0xg", None),
        ("0xF_F", Some("an integer")),
        ("-0x1", Some("an integer")),
        ("+0b1", Some("an integer")),
        ("12", Some("an integer")),
        ("1_2", Some("an integer")),
        ...
        ("abcd-01-01", None),
        ("2024-01-0a", None),
        ("2024-01-01 1:02:03", Some("a timestamp")),
        ("2024-01-01T01:02:03", Some("a timestamp")),
        ("2024-1-1t1:02:03", Some("a timestamp")),
        ("2024-01-01  01:02:03", Some("a timestamp")),
        ("2024-01-01 01:02:03.5", Some("a timestamp")),
        ("2024-01-01 01:02:03.", Some("a timestamp")),
        ("2024-01-01 01:02:03Z", Some("a timestamp")),
        ("2024-01-01 01:02:03 Z", Some("a timestamp")),
        ("2024-01-01 01:02:03+1", Some("a timestamp")),
        ("2024-01-01 01:02:03-05:00", Some("a timestamp")),
        ("2024-01-01 01:02:03+05:0", None),
        ("2024-01-01 01:02:03+123", None),
        ("2024-01-01 01:2:03", None),
        ("2024-01-01 01:02:3", None),
        ("2024-01-01 001:02:03", None),
        ("2024-01-01 01:02", None),
        ("2024-01-01 01:02:03:04", None),
        ("2024-01-01 01:02:03.5a", None),
        ("2024-01-01T", None),
        ("2024-001-01 01:02:03", None),
        ("2024-01-01 01:02:03 +05:00", Some("a timestamp")),
    ];

    /// Every branch of each resolver at its edges: sexagesimal groups, bases,
    /// underscores, signs, exponents, and each part of a timestamp. The
    /// expected types were produced by `yaml.safe_load` (`PyYAML` 6.0.1) for
    /// each value written unquoted after `v: `; inputs `PyYAML` cannot scan as
    /// a scalar (`1:`, `-`) are left out.
    #[test]
    fn matches_pyyaml_at_every_resolver_edge() {
        for &(value, want) in RESOLVER_EDGES {
            assert_eq!(implicit_type(value), want, "{value:?}");
        }
    }
}
