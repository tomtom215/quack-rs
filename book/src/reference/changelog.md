...
- **`TableFunctionBuilder`** — type-safe builder for registering DuckDB table functions
  ...
  [`table`](https://github.com/tomtom215/quack-rs/blob/main/src/table/mod.rs) and `examples/hello-ext` (`generate_series_ext`) for
...
- **`ReplacementScanBuilder`** — builder for registering DuckDB replacement scans
  ...
  population through a 4-method chain. See [`replacement_scan`](https://github.com/tomtom215/quack-rs/tree/main/src/replacement_scan/).
...
- **`CastFunctionBuilder`** — type-safe builder for registering custom type cast
  ...
  See [`cast`](https://github.com/tomtom215/quack-rs/tree/main/src/cast/) for the full API.
...
- **`DbConfig`** — RAII wrapper for `duckdb_config` (extension configuration
  ...
  callbacks. See [`config`](https://github.com/tomtom215/quack-rs/blob/main/src/config.rs).
